...
public class ApiRestController {
    ...
    @DeleteMapping(path = FROBULATORS_PATH + "/{identifier}")
    public ResponseEntity<Void> deleteFrobulator(@PathVariable("identifier") String identifier) {

        return adapter.deleteFrobulator(identifier);
    }
}
